...
struct JsonNewsfeedResponse: Codable {
    ...
    let profiles: [JsonNewsfeedProfile]
    let groups: [JsonNewsfeedGroup]
}

// MARK: - Group
struct JsonNewsfeedGroup: Codable {
    let id: Int
...
// MARK: - Profile
struct JsonNewsfeedProfile: Codable {
    let id: Int
